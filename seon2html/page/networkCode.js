...
nodes: [
  ...
  {data: {id:'12', name:'UIT&EO', dim:100, level:3, color:'#ffff99'}},
  {data: {id:'13', name:'GORO', dim:106, level:3, color:'#ffff99'}},
  {data: {id:'14', name:'HCIMO', dim:100, level:3, color:'#ffff99'}},
  {data: {id:'15', name:'RDPO', dim:112, level:3, color:'#ffff99'}},
  {data: {id:'16', name:'CUO', dim:100, level:3, color:'#ffff99'}},
  {data: {id:'17', name:'DPO', dim:130, level:3, color:'#ffff99'}},
  {data: {id:'18', name:'UCO', dim:100, level:3, color:'#ffff99'}},
  {data: {id:'19', name:'CPO', dim:110, level:3, color:'#ffff99'}},
  {data: {id:'20', name:'HCIQCO', dim:100, level:3, color:'#ffff99'}},
  {data: {id:'21', name:'ROoST', dim:151, level:3, color:'#ffff99'}},
  {data: {id:'22', name:'QAPO', dim:120, level:3, color:'#ffff99'}},
  {data: {id:'23', name:'SPMO', dim:121, level:3, color:'#ffff99'}},
  {data: {id:'24', name:'CMPO', dim:147, level:3, color:'#ffff99'}},
  {data: {id:'25', name:'RSMO', dim:148, level:3, color:'#ffff99'}},
], 
...
edges: [
  ...
  {data: {id:'e9', thickness:1, weight:1, source:'2', target:'23'}},
  {data: {id:'e10', thickness:6, weight:8, source:'2', target:'25'}},
  ...
  {data: {id:'e15', thickness:1, weight:1, source:'3', target:'25'}},
  ...
  {data: {id:'e19', thickness:1, weight:1, source:'5', target:'22'}},
  ...
  {data: {id:'e38', thickness:7, weight:9, source:'9', target:'15'}},
  ...
  {data: {id:'e43', thickness:2, weight:2, source:'13', target:'0'}},
  {data: {id:'e44', thickness:1, weight:1, source:'13', target:'9'}},
  {data: {id:'e45', thickness:6, weight:7, source:'15', target:'2'}},
  {data: {id:'e46', thickness:3, weight:3, source:'15', target:'3'}},
  {data: {id:'e47', thickness:6, weight:7, source:'15', target:'9'}},
  {data: {id:'e48', thickness:12, weight:15, source:'17', target:'2'}},
  {data: {id:'e49', thickness:6, weight:7, source:'17', target:'3'}},
  {data: {id:'e50', thickness:3, weight:3, source:'17', target:'9'}},
  {data: {id:'e51', thickness:6, weight:7, source:'19', target:'2'}},
  {data: {id:'e52', thickness:3, weight:4, source:'19', target:'3'}},
  {data: {id:'e53', thickness:2, weight:2, source:'19', target:'9'}},
  {data: {id:'e54', thickness:2, weight:2, source:'19', target:'17'}},
  {data: {id:'e55', thickness:11, weight:14, source:'21', target:'2'}},
  {data: {id:'e56', thickness:11, weight:14, source:'21', target:'3'}},
  {data: {id:'e57', thickness:10, weight:13, source:'22', target:'2'}},
  {data: {id:'e58', thickness:3, weight:4, source:'22', target:'3'}},
  {data: {id:'e59', thickness:3, weight:3, source:'22', target:'23'}},
  {data: {id:'e60', thickness:11, weight:14, source:'23', target:'2'}},
  {data: {id:'e61', thickness:2, weight:2, source:'23', target:'3'}},
  {data: {id:'e62', thickness:1, weight:1, source:'23', target:'22'}},
  {data: {id:'e63', thickness:2, weight:2, source:'24', target:'0'}},
  {data: {id:'e64', thickness:16, weight:21, source:'24', target:'2'}},
  {data: {id:'e65', thickness:6, weight:7, source:'24', target:'3'}},
  {data: {id:'e66', thickness:2, weight:2, source:'24', target:'22'}},
  {data: {id:'e67', thickness:3, weight:4, source:'25', target:'0'}},
  {data: {id:'e68', thickness:13, weight:17, source:'25', target:'2'}},
  {data: {id:'e69', thickness:6, weight:8, source:'25', target:'3'}},
  {data: {id:'e70', thickness:11, weight:14, source:'25', target:'4'}},
  {data: {id:'e71', thickness:1, weight:1, source:'25', target:'5'}},
]
  },
